...
// /___/   /\     Timestamp : 03/13/2025 15:57:48
// \   \  /  \ 
//  \___\/\___\ 
//
...
module Pipeline_demo(clk, 
   ...
   PC3 XLXI_4 (.clk(clk), 
               .PC_ctrl(PC_ctrl), 
               .PC_next(PC3_next_out[6:0]), 
               .rst(rst), 
               .thread(thread_IF[1:0]), 
               .thread_ID(thread_ID[1:0]), 
               .PC(PC3[6:0]));
   PC_Thread_MUX XLXI_5 (.PC0(PC0[6:0]), 
                         .PC1(PC1[6:0]), 
                         .PC2(PC2[6:0]), 
                         .PC3(PC3[6:0]), 
                         .thread(thread_IF[1:0]), 
   ...
   PC_plus_1 XLXI_6 (.ONE(ONE[6:0]), 
                     .PC(PC0[6:0]), 
                     .PC_next(PC0_plus_1[6:0]));
   PC_plus_1 XLXI_7 (.ONE(ONE[6:0]), 
                     .PC(PC1[6:0]), 
                     .PC_next(PC1_plus_1[6:0]));
   PC_plus_1 XLXI_8 (.ONE(ONE[6:0]), 
                     .PC(PC2[6:0]), 
                     .PC_next(PC2_plus_1[6:0]));
   PC_plus_1 XLXI_9 (.ONE(ONE[6:0]), 
                     .PC(PC3[6:0]), 
                     .PC_next(PC3_plus_1[6:0]));
   PC_MUX XLXI_10 (.BTA(Offset_ID[6:0]), 
                   .PC_ctrl(PC_ctrl), 
                   .PC_next_in(PC0_plus_1[6:0]), 
                   .PC_next_out(PC0_next[6:0]));
   PC_MUX XLXI_11 (.BTA(Offset_ID[6:0]), 
                   .PC_ctrl(PC_ctrl), 
                   .PC_next_in(PC1_plus_1[6:0]), 
                   .PC_next_out(PC1_next[6:0]));
   PC_MUX XLXI_12 (.BTA(Offset_ID[6:0]), 
                   .PC_ctrl(PC_ctrl), 
                   .PC_next_in(PC2_plus_1[6:0]), 
                   .PC_next_out(PC2_next_out[6:0]));
   PC_MUX XLXI_13 (.BTA(Offset_ID[6:0]), 
                   .PC_ctrl(PC_ctrl), 
                   .PC_next_in(PC3_plus_1[6:0]), 
                   .PC_next_out(PC3_next_out[6:0]));
   ...
   Control_Unit XLXI_31 (.OP_CODE(OP_CODE_ID[5:0]), 
                         ...
                         .WME_ID(WME_ID), 
                         .WRE_ID(WRE_ID));
   Branch_Detection_Unit XLXI_32 (.BEQ_ID(XLXN_50), 
                                  .BGT_ID(XLXN_51), 
                                  .BLT_ID(XLXN_52), 
                                  .J_ID(XLXN_53), 
